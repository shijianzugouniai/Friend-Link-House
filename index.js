...
var feed = new RSS({
  ...
  description: "给自己的生活做个记录",
  feed_url: "https://blogroll.hello.moe/rss.xml",
  site_url: "https://blogroll.hello.moe/",
  image_url: "https://blogroll.icl.moe/assets/logo.png",
  docs: "https://blogroll..hello.icl.moe",
  managingEditor: "ajiatu",
  webMaster: "ajiatu",
